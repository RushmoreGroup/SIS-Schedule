...
{
    [Table("ztblNDSISNotice", Schema ="dbo")]
    public class ztblNDSISNotice
    {
		[Key]
	...
	public string AssmentAddress { get; set; }
	public string AssessmentCity { get; set; }
	public string AssessmentNotes { get; set; }
	public string AssessmentPhone { get; set; }
